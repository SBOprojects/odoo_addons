...
def encrypt_data(data: str, secret_key: str) -> str:
    ...
    print(f"Data to be encrypted: {data}")  # Print data before encryption
    print(f"Encrypted data: {encrypted_data.decode()}")  # Print encrypted data
    return encrypted_data.decode()

def decrypt_data(encrypted_data: str, secret_key: str) -> str:
    f = Fernet(secret_key)
    decrypted_data = f.decrypt(encrypted_data.encode())
    print(f"Encrypted data to be decrypted: {encrypted_data}")  # Print encrypted data before decryption
    print(f"Decrypted data: {decrypted_data.decode()}")  # Print decrypted data
