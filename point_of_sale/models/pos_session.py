...
class PosSession(models.Model):
    ...
    def get_closing_control_data(self):
            ...
            #Add order lines
            orders_details_list = [] #this edit is done by Rami
            products_info = {
                'qty': 0,
                'total': 0
            }
            ...
            for order in orders:
                ...
                for line in order.lines:
                    ...
                    print('**********************************************')
                    print(line.product_id.product_tmpl_id.categ_id.name)
                    categoryName = line.product_id.product_tmpl_id.categ_id.name
            ...
            data = {
                'orders_details': {     #this edit is done by Rami
                ...
                'is_manager': self.env.user.has_group("point_of_sale.group_pos_manager"),
                'amount_authorized_diff': self.config_id.amount_authorized_diff if self.config_id.set_maximum_difference else None,
                'company':current_company.account_sale_tax_id.amount,
                'total_cash_payment': total_default_cash_payment_amount+total_card_payment_amount,
            }
            print("Data being returned to client:",data)
            return data 
