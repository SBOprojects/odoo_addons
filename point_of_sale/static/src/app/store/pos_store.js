...
export class PosStore extends Reactive {
    ...
    async onDeleteOrder(order) {
        ...
        if (order.get_orderlines().length > 0) {
            ...
            const reason = await ask(this.dialog, {
                title: _t("Write a reason"),
                body: `
                    
                `,
                confirmText: _t("Submit"),
                cancelText: _t("Cancel"),
                // This ensures the body content is rendered as HTML
                renderAsHtml: true // or similar depending on your dialog framework
            });      }
